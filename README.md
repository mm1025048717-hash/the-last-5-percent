...
| 工具 | 功能 | 说明 |
|-----|------|------|
| 🔍 `review_search` | 评论搜索 | 从什么值得买、知乎、京东等平台获取真实用户评价 |
| 📊 `product_spec_analysis` | 参数分析 | 分析产品技术参数，发现虚标、设计缺陷等问题 |
| 📁 `history_search` | 历史搜索 | 搜索产品召回、已知缺陷、换壳重生等黑历史 |
| ⚡ `scenario_analysis` | 场景分析 | 基于用户使用场景预测产品可能遇到的问题 |
